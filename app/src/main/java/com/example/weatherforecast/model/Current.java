...
public class Current {
    ...
    public Current(int last_update_epoch, String last_updated, double temp_c, double temp_f, int is_day, Condition condition, double wind_mph, double wind_kph, int wind_degree, String wind_dir, double pressure_mb, double pressure_in, double precip_mm, double precip_in, int humidity, int cloud, double feelslike_c, double feelslike_f, double vis_km, double vis_miles, double uv, double gust_mph, double gust_kph, AirQuality air_quality) {
    ...
    public int getLast_update_epoch() {
        return last_update_epoch;
    }

    public void setLast_update_epoch(int last_update_epoch) {
        this.last_update_epoch = last_update_epoch;
    }
